defmodule Validator do
  @trasitisions_table [
    start:  [op: :error,  number: :number, left: :left,  right: :error, dot: :error],
    number: [op: :op,     number: :number, left: :error, right: :right, dot: :dot],
    op:     [op: :error,  number: :number, left: :left,  right: :error, dot: :error],
    left:   [op: :error,  number: :number, left: :left,  right: :error, dot: :error],
    right:  [op: :op,     number: :error,  left: :error, right: :right, dot: :error],
    dot:    [op: :error,  number: :float,  left: :error, right: :error, dot: :error],
    float:  [op: :op,     number: :float,  left: :error, right: :right, dot: :error],
  ]
